# P3 — delivery plan for participation *(archived 2026-08-19)*

> **Archived. The live plan is P4 (`PLAN.md`).** P3 is retained as the delivery
> record for Phase 0 and Phases E1.0–E1.4, and as the target of existing "P3 §…"
> citations. P4 is P3 **restructured, not superseded**: the diagnosis, the
> phases, the ordering rationale and every epic below are unchanged in substance.
> What changed is where the instruments live — P3 put them all in Phase 8, and
> P4 builds them inside Phases 1–3 where the work that produces the data is.
> P4 §"Where P3's Phase 8 epics land" maps every id.
